...
public interface ShortLinkNetworkStatsMapper extends BaseMapper<ShortLinkNetworkStatisticsDO> {
    ...
    List<ShortLinkNetworkStatisticsDO> listNetworkStatsByShortLink(@Param("requestParam") ShortLinkStatsReqDTO requestParam);
    ...
    List<ShortLinkNetworkStatisticsDO> listNetworkStatsByGroup(@Param("requestParam") ShortLinkGroupStatsReqDTO requestParam);
}

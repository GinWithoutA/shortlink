...
import org.ginwithouta.shortlink.admin.config.UserFlowRiskControlConfiguration;
...
import static org.ginwithouta.shortlink.admin.common.enums.UserErrorCodeEnums.USER_FLOW_LIMIT_ERROR;
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        if (userFlowRiskControlConfiguration.getEnable()) {
            ...
            try {
                ...
                returnJson((HttpServletResponse) servletResponse, JSON.toJSONString(Results.failure(new ClientException(USER_FLOW_LIMIT_ERROR))));
            }
